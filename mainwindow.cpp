...
void MainWindow::on_pushButton_add_clicked()
{
    ...
    m_addstudentinfo->setTheme(isdarkmode);
...

{
    ...
    analyzeDialog.setTheme(isdarkmode);
    analyzeDialog.exec();
...
void MainWindow::switchTheme(bool isDarkMode)
{
    ...
    if (isDarkMode) {
        ...
        ui->menubar->setStyleSheet("QMenuBar { background-color: black; color: white; }"
                                   ...
                                   "QMenu::item { padding: 2px 20px; }"
                                   "QMenu::item:selected { background-color: #555; color: white; }"
                                   "QAction { color: white; }");
        ui->label_id->setStyleSheet("QLabel { color: white; }");
        ...
        ui->centralwidget->setStyleSheet("QWidget { background-color: #333; }");
        ui->tableView->setStyleSheet("QTableView { background-color: #333; color: white; }");
        this->setStyleSheet("QMenuBar { background-color: black; color: white; }");
        ...
        ui->menubar->setStyleSheet("QMenuBar { background-color: #EEE; color: black; }"
                                          ...
                                          "QMenu::item { padding: 2px 20px; }"
                                          "QMenu::item:selected { background-color: #DDD; color: black; }"
                                          "QAction { color: black; }");
        ui->label_id->setStyleSheet("QLabel { color: black; }");
        ...
        this->setStyleSheet("QMenuBar { background-color: #EEE; color: black; }");
        ui->statusbar->setStyleSheet("QStatusBar { background-color: white; color: black; }");
...
bool MainWindow::isDarkModeEnabled()
{
    ...
    isdarkmode= settings.value("AppsUseLightTheme", 1).toInt();
